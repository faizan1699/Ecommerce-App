...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = 'new814am9august_f34fac712c4852424488_20240809031511_archive.daf';
        const ARCHIVE_SIZE           = '162373784';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = 'f34fac7-09031511';
        const SECONDARY_PACKAGE_HASH = 'fecb0fc-09031511';
